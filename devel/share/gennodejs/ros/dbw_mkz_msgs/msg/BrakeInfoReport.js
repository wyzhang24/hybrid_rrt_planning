...
class BrakeInfoReport {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('brake_pedal_qf')) {
        this.brake_pedal_qf = initObj.brake_pedal_qf
      }
      else {
        this.brake_pedal_qf = new QualityFactor();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [brake_pedal_qf]
    bufferOffset = QualityFactor.serialize(obj.brake_pedal_qf, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [brake_pedal_qf]
    data.brake_pedal_qf = QualityFactor.deserialize(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return 'f0dc6f9424f2cb9fca59bce960b68010';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.brake_pedal_qf !== undefined) {
      resolved.brake_pedal_qf = QualityFactor.Resolve(msg.brake_pedal_qf)
    }
    else {
      resolved.brake_pedal_qf = new QualityFactor()
    }
