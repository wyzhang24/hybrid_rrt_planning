...
class Misc1Report {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.btn_rd_ok = null;
      this.btn_rd_up = null;
      this.btn_rd_down = null;
      this.btn_rd_left = null;
      this.btn_rd_right = null;
      this.btn_vol_inc = null;
      this.btn_vol_dec = null;
      this.btn_mute = null;
      this.btn_media = null;
      this.btn_prev = null;
      this.btn_next = null;
      this.btn_speak = null;
      this.btn_call_start = null;
      this.btn_call_end = null;
      this.fault_bus = null;
      ...
      if (initObj.hasOwnProperty('outside_temperature')) {
        this.outside_temperature = initObj.outside_temperature
      }
      else {
        this.outside_temperature = 0.0;
      }
      ...
      if (initObj.hasOwnProperty('btn_rd_ok')) {
        this.btn_rd_ok = initObj.btn_rd_ok
      }
      else {
        this.btn_rd_ok = false;
      }
      if (initObj.hasOwnProperty('btn_rd_up')) {
        this.btn_rd_up = initObj.btn_rd_up
      }
      else {
        this.btn_rd_up = false;
      }
      if (initObj.hasOwnProperty('btn_rd_down')) {
        this.btn_rd_down = initObj.btn_rd_down
      }
      else {
        this.btn_rd_down = false;
      }
      if (initObj.hasOwnProperty('btn_rd_left')) {
        this.btn_rd_left = initObj.btn_rd_left
      }
      else {
        this.btn_rd_left = false;
      }
      if (initObj.hasOwnProperty('btn_rd_right')) {
        this.btn_rd_right = initObj.btn_rd_right
      }
      else {
        this.btn_rd_right = false;
      }
      if (initObj.hasOwnProperty('btn_vol_inc')) {
        this.btn_vol_inc = initObj.btn_vol_inc
      }
      else {
        this.btn_vol_inc = false;
      }
      if (initObj.hasOwnProperty('btn_vol_dec')) {
        this.btn_vol_dec = initObj.btn_vol_dec
      }
      else {
        this.btn_vol_dec = false;
      }
      ...
      if (initObj.hasOwnProperty('btn_media')) {
        this.btn_media = initObj.btn_media
      }
      else {
      ...
      if (initObj.hasOwnProperty('btn_speak')) {
        this.btn_speak = initObj.btn_speak
      }
      else {
        this.btn_speak = false;
      }
      if (initObj.hasOwnProperty('btn_call_start')) {
        this.btn_call_start = initObj.btn_call_start
      }
      else {
        this.btn_call_start = false;
      }
      if (initObj.hasOwnProperty('btn_call_end')) {
        this.btn_call_end = initObj.btn_call_end
      }
      else {
        this.btn_call_end = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [outside_temperature]
    bufferOffset = _serializer.float32(obj.outside_temperature, buffer, bufferOffset);
    ...
    // Serialize message field [btn_rd_ok]
    bufferOffset = _serializer.bool(obj.btn_rd_ok, buffer, bufferOffset);
    // Serialize message field [btn_rd_up]
    bufferOffset = _serializer.bool(obj.btn_rd_up, buffer, bufferOffset);
    // Serialize message field [btn_rd_down]
    bufferOffset = _serializer.bool(obj.btn_rd_down, buffer, bufferOffset);
    // Serialize message field [btn_rd_left]
    bufferOffset = _serializer.bool(obj.btn_rd_left, buffer, bufferOffset);
    // Serialize message field [btn_rd_right]
    bufferOffset = _serializer.bool(obj.btn_rd_right, buffer, bufferOffset);
    // Serialize message field [btn_vol_inc]
    bufferOffset = _serializer.bool(obj.btn_vol_inc, buffer, bufferOffset);
    // Serialize message field [btn_vol_dec]
    bufferOffset = _serializer.bool(obj.btn_vol_dec, buffer, bufferOffset);
    // Serialize message field [btn_mute]
    bufferOffset = _serializer.bool(obj.btn_mute, buffer, bufferOffset);
    // Serialize message field [btn_media]
    bufferOffset = _serializer.bool(obj.btn_media, buffer, bufferOffset);
    ...
    // Serialize message field [btn_speak]
    bufferOffset = _serializer.bool(obj.btn_speak, buffer, bufferOffset);
    // Serialize message field [btn_call_start]
    bufferOffset = _serializer.bool(obj.btn_call_start, buffer, bufferOffset);
    // Serialize message field [btn_call_end]
    bufferOffset = _serializer.bool(obj.btn_call_end, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [outside_temperature]
    data.outside_temperature = _deserializer.float32(buffer, bufferOffset);
    ...
    // Deserialize message field [btn_rd_ok]
    data.btn_rd_ok = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [btn_rd_up]
    data.btn_rd_up = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [btn_rd_down]
    data.btn_rd_down = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [btn_rd_left]
    data.btn_rd_left = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [btn_rd_right]
    data.btn_rd_right = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [btn_vol_inc]
    data.btn_vol_inc = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [btn_vol_dec]
    data.btn_vol_dec = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [btn_mute]
    data.btn_mute = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [btn_media]
    data.btn_media = _deserializer.bool(buffer, bufferOffset);
    ...
    // Deserialize message field [btn_speak]
    data.btn_speak = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [btn_call_start]
    data.btn_call_start = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [btn_call_end]
    data.btn_call_end = _deserializer.bool(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return '551ea602464aaab22bc1752e844dde30';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.outside_temperature !== undefined) {
      resolved.outside_temperature = msg.outside_temperature;
    }
    else {
      resolved.outside_temperature = 0.0
    }
    ...
    if (msg.btn_rd_ok !== undefined) {
      resolved.btn_rd_ok = msg.btn_rd_ok;
    }
    else {
      resolved.btn_rd_ok = false
    }

    if (msg.btn_rd_up !== undefined) {
      resolved.btn_rd_up = msg.btn_rd_up;
    }
    else {
      resolved.btn_rd_up = false
    }

    if (msg.btn_rd_down !== undefined) {
      resolved.btn_rd_down = msg.btn_rd_down;
    }
    else {
      resolved.btn_rd_down = false
    }

    if (msg.btn_rd_left !== undefined) {
      resolved.btn_rd_left = msg.btn_rd_left;
    }
    else {
      resolved.btn_rd_left = false
    }

    if (msg.btn_rd_right !== undefined) {
      resolved.btn_rd_right = msg.btn_rd_right;
    }
    else {
      resolved.btn_rd_right = false
    }

    if (msg.btn_vol_inc !== undefined) {
      resolved.btn_vol_inc = msg.btn_vol_inc;
    }
    else {
      resolved.btn_vol_inc = false
    }

    if (msg.btn_vol_dec !== undefined) {
      resolved.btn_vol_dec = msg.btn_vol_dec;
    }
    else {
      resolved.btn_vol_dec = false
    }
    ...
    if (msg.btn_media !== undefined) {
      resolved.btn_media = msg.btn_media;
    }
    else {
      resolved.btn_media = false
    }
    ...
    if (msg.btn_speak !== undefined) {
      resolved.btn_speak = msg.btn_speak;
    }
    else {
      resolved.btn_speak = false
    }

    if (msg.btn_call_start !== undefined) {
      resolved.btn_call_start = msg.btn_call_start;
    }
    else {
      resolved.btn_call_start = false
    }

    if (msg.btn_call_end !== undefined) {
      resolved.btn_call_end = msg.btn_call_end;
    }
    else {
      resolved.btn_call_end = false
    }
