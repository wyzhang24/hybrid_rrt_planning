...
class BrakeReport {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('decel_cmd')) {
        this.decel_cmd = initObj.decel_cmd
      }
      else {
        this.decel_cmd = 0.0;
      }
      if (initObj.hasOwnProperty('decel_output')) {
        this.decel_output = initObj.decel_output
      }
      else {
        this.decel_output = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [decel_cmd]
    bufferOffset = _serializer.float32(obj.decel_cmd, buffer, bufferOffset);
    // Serialize message field [decel_output]
    bufferOffset = _serializer.float32(obj.decel_output, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [decel_cmd]
    data.decel_cmd = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [decel_output]
    data.decel_output = _deserializer.float32(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return 'd99bccbe9927a92147840ac1ddf11f87';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.decel_cmd !== undefined) {
      resolved.decel_cmd = msg.decel_cmd;
    }
    else {
      resolved.decel_cmd = 0.0
    }

    if (msg.decel_output !== undefined) {
      resolved.decel_output = msg.decel_output;
    }
    else {
      resolved.decel_output = 0.0
    }
