...
(cl:defmethod cl:initialize-instance :after ((m <Control>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Control)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mcity_msg-msg:<Control> is deprecated: use mcity_msg-msg:Control instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <Control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcity_msg-msg:timestamp-val is deprecated.  Use mcity_msg-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'count-val :lambda-list '(m))
(cl:defmethod count-val ((m <Control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcity_msg-msg:count-val is deprecated.  Use mcity_msg-msg:count instead.")
  (count m))

(cl:ensure-generic-function 'brake_cmd-val :lambda-list '(m))
(cl:defmethod brake_cmd-val ((m <Control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcity_msg-msg:brake_cmd-val is deprecated.  Use mcity_msg-msg:brake_cmd instead.")
  (brake_cmd m))

(cl:ensure-generic-function 'throttle_cmd-val :lambda-list '(m))
(cl:defmethod throttle_cmd-val ((m <Control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcity_msg-msg:throttle_cmd-val is deprecated.  Use mcity_msg-msg:throttle_cmd instead.")
  (throttle_cmd m))

(cl:ensure-generic-function 'steering_cmd-val :lambda-list '(m))
(cl:defmethod steering_cmd-val ((m <Control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcity_msg-msg:steering_cmd-val is deprecated.  Use mcity_msg-msg:steering_cmd instead.")
  (steering_cmd m))

(cl:ensure-generic-function 'gear_cmd-val :lambda-list '(m))
(cl:defmethod gear_cmd-val ((m <Control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcity_msg-msg:gear_cmd-val is deprecated.  Use mcity_msg-msg:gear_cmd instead.")
  (gear_cmd m))

(cl:ensure-generic-function 'turn_signal_cmd-val :lambda-list '(m))
(cl:defmethod turn_signal_cmd-val ((m <Control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcity_msg-msg:turn_signal_cmd-val is deprecated.  Use mcity_msg-msg:turn_signal_cmd instead.")
  (turn_signal_cmd m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Control>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'throttle_cmd))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'steering_cmd))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Control>) istream)
  "Deserializes a message object of type '<Control>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'steering_cmd) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Control>)))
  ...
  "8991eb8db72ef6936a21cd28b0eaadf3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Control)))
  "Returns md5sum for a message object of type 'Control"
  "8991eb8db72ef6936a21cd28b0eaadf3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Control>)))
  ...
  (cl:format cl:nil "~%float64 timestamp~%int32 	count~%float64 brake_cmd~%float64 throttle_cmd~%float64 steering_cmd~%int16 	gear_cmd~%int16 	turn_signal_cmd~%~% ~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Control)))
  "Returns full string definition for message of type 'Control"
  (cl:format cl:nil "~%float64 timestamp~%int32 	count~%float64 brake_cmd~%float64 throttle_cmd~%float64 steering_cmd~%int16 	gear_cmd~%int16 	turn_signal_cmd~%~% ~%~%~%"))
