...
(cl:ensure-generic-function 'decel_cmd-val :lambda-list '(m))
(cl:defmethod decel_cmd-val ((m <BrakeReport>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:decel_cmd-val is deprecated.  Use dbw_mkz_msgs-msg:decel_cmd instead.")
  (decel_cmd m))

(cl:ensure-generic-function 'decel_output-val :lambda-list '(m))
(cl:defmethod decel_output-val ((m <BrakeReport>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:decel_output-val is deprecated.  Use dbw_mkz_msgs-msg:decel_output instead.")
  (decel_output m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <BrakeReport>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'torque_output))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'decel_cmd))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'decel_output))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BrakeReport>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'decel_cmd) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'decel_output) (roslisp-utils:decode-single-float-bits bits)))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<BrakeReport>)))
  ...
  "d99bccbe9927a92147840ac1ddf11f87")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'BrakeReport)))
  "Returns md5sum for a message object of type 'BrakeReport"
  "d99bccbe9927a92147840ac1ddf11f87")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <BrakeReport>))
  ...
  (cl:list 'BrakeReport
    ...
    (cl:cons ':decel_cmd (decel_cmd msg))
    (cl:cons ':decel_output (decel_output msg))
