...
(cl:defmethod steering_wheel_torque_cmd-val ((m <SteeringCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:steering_wheel_torque_cmd-val is deprecated.  Use dbw_mkz_msgs-msg:steering_wheel_torque_cmd instead.")
  (steering_wheel_torque_cmd m))

(cl:ensure-generic-function 'cmd_type-val :lambda-list '(m))
(cl:defmethod cmd_type-val ((m <SteeringCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:cmd_type-val is deprecated.  Use dbw_mkz_msgs-msg:cmd_type instead.")
  (cmd_type m))
