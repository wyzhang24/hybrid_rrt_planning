...
(cl:defclass <BrakeInfoReport> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (accel_over_ground
    ...
    :initform 0.0)
   (brake_pedal_qf
    :reader brake_pedal_qf
    :initarg :brake_pedal_qf
...
(cl:ensure-generic-function 'brake_pedal_qf-val :lambda-list '(m))
(cl:defmethod brake_pedal_qf-val ((m <BrakeInfoReport>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:brake_pedal_qf-val is deprecated.  Use dbw_mkz_msgs-msg:brake_pedal_qf instead.")
  (brake_pedal_qf m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <BrakeInfoReport>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'accel_over_ground))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'brake_pedal_qf) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BrakeInfoReport>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'brake_pedal_qf) istream)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<BrakeInfoReport>)))
  ...
  "f0dc6f9424f2cb9fca59bce960b68010")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'BrakeInfoReport)))
  "Returns md5sum for a message object of type 'BrakeInfoReport"
  "f0dc6f9424f2cb9fca59bce960b68010")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <BrakeInfoReport>))
  (cl:+ 0
     ...
     4
     4
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'brake_pedal_qf))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <BrakeInfoReport>))
  ...
  (cl:list 'BrakeInfoReport
    ...
    (cl:cons ':brake_pedal_qf (brake_pedal_qf msg))
    (cl:cons ':hsa (hsa msg))
