...
(cl:defclass <Misc1Report> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (outside_temperature
    :reader outside_temperature
    :initarg :outside_temperature
    :type cl:float
    :initform 0.0)
   (btn_cc_on
    :reader btn_cc_on
   ...
   (btn_speak
    ...
    :initform cl:nil)
   (btn_call_start
    :reader btn_call_start
    :initarg :btn_call_start
    :type cl:boolean
    :initform cl:nil)
   (btn_call_end
    :reader btn_call_end
    :initarg :btn_call_end
    :type cl:boolean
    :initform cl:nil)
   (fault_bus
    :reader fault_bus
...
(cl:ensure-generic-function 'outside_temperature-val :lambda-list '(m))
(cl:defmethod outside_temperature-val ((m <Misc1Report>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:outside_temperature-val is deprecated.  Use dbw_mkz_msgs-msg:outside_temperature instead.")
  (outside_temperature m))
...
(cl:ensure-generic-function 'btn_rd_ok-val :lambda-list '(m))
(cl:defmethod btn_rd_ok-val ((m <Misc1Report>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:btn_rd_ok-val is deprecated.  Use dbw_mkz_msgs-msg:btn_rd_ok instead.")
  (btn_rd_ok m))

(cl:ensure-generic-function 'btn_rd_up-val :lambda-list '(m))
(cl:defmethod btn_rd_up-val ((m <Misc1Report>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:btn_rd_up-val is deprecated.  Use dbw_mkz_msgs-msg:btn_rd_up instead.")
  (btn_rd_up m))

(cl:ensure-generic-function 'btn_rd_down-val :lambda-list '(m))
(cl:defmethod btn_rd_down-val ((m <Misc1Report>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:btn_rd_down-val is deprecated.  Use dbw_mkz_msgs-msg:btn_rd_down instead.")
  (btn_rd_down m))

(cl:ensure-generic-function 'btn_rd_left-val :lambda-list '(m))
(cl:defmethod btn_rd_left-val ((m <Misc1Report>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:btn_rd_left-val is deprecated.  Use dbw_mkz_msgs-msg:btn_rd_left instead.")
  (btn_rd_left m))

(cl:ensure-generic-function 'btn_rd_right-val :lambda-list '(m))
(cl:defmethod btn_rd_right-val ((m <Misc1Report>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:btn_rd_right-val is deprecated.  Use dbw_mkz_msgs-msg:btn_rd_right instead.")
  (btn_rd_right m))

(cl:ensure-generic-function 'btn_vol_inc-val :lambda-list '(m))
(cl:defmethod btn_vol_inc-val ((m <Misc1Report>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:btn_vol_inc-val is deprecated.  Use dbw_mkz_msgs-msg:btn_vol_inc instead.")
  (btn_vol_inc m))

(cl:ensure-generic-function 'btn_vol_dec-val :lambda-list '(m))
(cl:defmethod btn_vol_dec-val ((m <Misc1Report>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:btn_vol_dec-val is deprecated.  Use dbw_mkz_msgs-msg:btn_vol_dec instead.")
  (btn_vol_dec m))

(cl:ensure-generic-function 'btn_mute-val :lambda-list '(m))
(cl:defmethod btn_mute-val ((m <Misc1Report>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:btn_mute-val is deprecated.  Use dbw_mkz_msgs-msg:btn_mute instead.")
  (btn_mute m))

(cl:ensure-generic-function 'btn_media-val :lambda-list '(m))
(cl:defmethod btn_media-val ((m <Misc1Report>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:btn_media-val is deprecated.  Use dbw_mkz_msgs-msg:btn_media instead.")
  (btn_media m))

(cl:ensure-generic-function 'btn_prev-val :lambda-list '(m))
(cl:defmethod btn_prev-val ((m <Misc1Report>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:btn_prev-val is deprecated.  Use dbw_mkz_msgs-msg:btn_prev instead.")
  (btn_prev m))

(cl:ensure-generic-function 'btn_next-val :lambda-list '(m))
(cl:defmethod btn_next-val ((m <Misc1Report>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:btn_next-val is deprecated.  Use dbw_mkz_msgs-msg:btn_next instead.")
  (btn_next m))

(cl:ensure-generic-function 'btn_speak-val :lambda-list '(m))
(cl:defmethod btn_speak-val ((m <Misc1Report>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:btn_speak-val is deprecated.  Use dbw_mkz_msgs-msg:btn_speak instead.")
  (btn_speak m))

(cl:ensure-generic-function 'btn_call_start-val :lambda-list '(m))
(cl:defmethod btn_call_start-val ((m <Misc1Report>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:btn_call_start-val is deprecated.  Use dbw_mkz_msgs-msg:btn_call_start instead.")
  (btn_call_start m))

(cl:ensure-generic-function 'btn_call_end-val :lambda-list '(m))
(cl:defmethod btn_call_end-val ((m <Misc1Report>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dbw_mkz_msgs-msg:btn_call_end-val is deprecated.  Use dbw_mkz_msgs-msg:btn_call_end instead.")
  (btn_call_end m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Misc1Report>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'outside_temperature))))
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'btn_rd_ok) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'btn_rd_up) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'btn_rd_down) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'btn_rd_left) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'btn_rd_right) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'btn_vol_inc) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'btn_vol_dec) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'btn_mute) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'btn_media) 1 0)) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'btn_speak) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'btn_call_start) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'btn_call_end) 1 0)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Misc1Report>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'ambient_light) istream)
    ...
    (cl:setf (cl:slot-value msg 'outside_temperature) (roslisp-utils:decode-single-float-bits bits)))
    ...
    (cl:setf (cl:slot-value msg 'btn_rd_ok) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'btn_rd_up) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'btn_rd_down) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'btn_rd_left) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'btn_rd_right) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'btn_vol_inc) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'btn_vol_dec) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'btn_mute) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'btn_media) (cl:not (cl:zerop (cl:read-byte istream))))
    ...
    (cl:setf (cl:slot-value msg 'btn_speak) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'btn_call_start) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'btn_call_end) (cl:not (cl:zerop (cl:read-byte istream))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Misc1Report>)))
  ...
  "551ea602464aaab22bc1752e844dde30")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Misc1Report)))
  "Returns md5sum for a message object of type 'Misc1Report"
  "551ea602464aaab22bc1752e844dde30")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Misc1Report>))
  ...
  (cl:list 'Misc1Report
    ...
    (cl:cons ':outside_temperature (outside_temperature msg))
    ...
    (cl:cons ':btn_rd_ok (btn_rd_ok msg))
    (cl:cons ':btn_rd_up (btn_rd_up msg))
    (cl:cons ':btn_rd_down (btn_rd_down msg))
    (cl:cons ':btn_rd_left (btn_rd_left msg))
    (cl:cons ':btn_rd_right (btn_rd_right msg))
    (cl:cons ':btn_vol_inc (btn_vol_inc msg))
    (cl:cons ':btn_vol_dec (btn_vol_dec msg))
    (cl:cons ':btn_mute (btn_mute msg))
    (cl:cons ':btn_media (btn_media msg))
    (cl:cons ':btn_prev (btn_prev msg))
    (cl:cons ':btn_next (btn_next msg))
    (cl:cons ':btn_speak (btn_speak msg))
    (cl:cons ':btn_call_start (btn_call_start msg))
    (cl:cons ':btn_call_end (btn_call_end msg))
