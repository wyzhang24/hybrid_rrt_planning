...
class BrakeReport(genpy.Message):
  _md5sum = "d99bccbe9927a92147840ac1ddf11f87"
...
"""
  __slots__ = ['header','pedal_input','pedal_cmd','pedal_output','torque_input','torque_cmd','torque_output','decel_cmd','decel_output','boo_input','boo_cmd','boo_output','enabled','override','driver','timeout','watchdog_counter','watchdog_braking','fault_wdc','fault_ch1','fault_ch2','fault_power']
  _slot_types = ['std_msgs/Header','float32','float32','float32','float32','float32','float32','float32','float32','bool','bool','bool','bool','bool','bool','bool','dbw_mkz_msgs/WatchdogCounter','bool','bool','bool','bool','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,pedal_input,pedal_cmd,pedal_output,torque_input,torque_cmd,torque_output,decel_cmd,decel_output,boo_input,boo_cmd,boo_output,enabled,override,driver,timeout,watchdog_counter,watchdog_braking,fault_wdc,fault_ch1,fault_ch2,fault_power
    ...
    if args or kwds:
      ...
      if self.decel_cmd is None:
        self.decel_cmd = 0.
      if self.decel_output is None:
        self.decel_output = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_8f13B().pack(_x.pedal_input, _x.pedal_cmd, _x.pedal_output, _x.torque_input, _x.torque_cmd, _x.torque_output, _x.decel_cmd, _x.decel_output, _x.boo_input, _x.boo_cmd, _x.boo_output, _x.enabled, _x.override, _x.driver, _x.timeout, _x.watchdog_counter.source, _x.watchdog_braking, _x.fault_wdc, _x.fault_ch1, _x.fault_ch2, _x.fault_power))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pedal_input, _x.pedal_cmd, _x.pedal_output, _x.torque_input, _x.torque_cmd, _x.torque_output, _x.decel_cmd, _x.decel_output, _x.boo_input, _x.boo_cmd, _x.boo_output, _x.enabled, _x.override, _x.driver, _x.timeout, _x.watchdog_counter.source, _x.watchdog_braking, _x.fault_wdc, _x.fault_ch1, _x.fault_ch2, _x.fault_power,) = _get_struct_8f13B().unpack(str[start:end])
...
def _get_struct_I():
    ...
    return _struct_I
_struct_8f13B = None
def _get_struct_8f13B():
    global _struct_8f13B
    if _struct_8f13B is None:
        _struct_8f13B = struct.Struct("<8f13B")
    return _struct_8f13B
_struct_3I = None
def _get_struct_3I():
    global _struct_3I
