...
class Misc1Report(genpy.Message):
  _md5sum = "551ea602464aaab22bc1752e844dde30"
...
uint8 NO_DATA=7
"""
  __slots__ = ['header','turn_signal','high_beam_headlights','wiper','ambient_light','outside_temperature','btn_cc_on','btn_cc_off','btn_cc_on_off','btn_cc_res','btn_cc_cncl','btn_cc_res_cncl','btn_cc_res_inc','btn_cc_res_dec','btn_cc_set_inc','btn_cc_set_dec','btn_cc_gap_inc','btn_cc_gap_dec','btn_la_on_off','btn_ld_ok','btn_ld_up','btn_ld_down','btn_ld_left','btn_ld_right','btn_rd_ok','btn_rd_up','btn_rd_down','btn_rd_left','btn_rd_right','btn_vol_inc','btn_vol_dec','btn_mute','btn_media','btn_prev','btn_next','btn_speak','btn_call_start','btn_call_end','fault_bus','door_driver','door_passenger','door_rear_left','door_rear_right','door_hood','door_trunk','passenger_detect','passenger_airbag','buckle_driver','buckle_passenger']
  _slot_types = ['std_msgs/Header','dbw_mkz_msgs/TurnSignal','bool','dbw_mkz_msgs/Wiper','dbw_mkz_msgs/AmbientLight','float32','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,turn_signal,high_beam_headlights,wiper,ambient_light,outside_temperature,btn_cc_on,btn_cc_off,btn_cc_on_off,btn_cc_res,btn_cc_cncl,btn_cc_res_cncl,btn_cc_res_inc,btn_cc_res_dec,btn_cc_set_inc,btn_cc_set_dec,btn_cc_gap_inc,btn_cc_gap_dec,btn_la_on_off,btn_ld_ok,btn_ld_up,btn_ld_down,btn_ld_left,btn_ld_right,btn_rd_ok,btn_rd_up,btn_rd_down,btn_rd_left,btn_rd_right,btn_vol_inc,btn_vol_dec,btn_mute,btn_media,btn_prev,btn_next,btn_speak,btn_call_start,btn_call_end,fault_bus,door_driver,door_passenger,door_rear_left,door_rear_right,door_hood,door_trunk,passenger_detect,passenger_airbag,buckle_driver,buckle_passenger
    ...
    if args or kwds:
      ...
      if self.btn_rd_ok is None:
        self.btn_rd_ok = False
      if self.btn_rd_up is None:
        self.btn_rd_up = False
      if self.btn_rd_down is None:
        self.btn_rd_down = False
      if self.btn_rd_left is None:
        self.btn_rd_left = False
      if self.btn_rd_right is None:
        self.btn_rd_right = False
      if self.btn_vol_inc is None:
        self.btn_vol_inc = False
      if self.btn_vol_dec is None:
        self.btn_vol_dec = False
      if self.btn_mute is None:
        self.btn_mute = False
      if self.btn_media is None:
        self.btn_media = False
      if self.btn_prev is None:
        self.btn_prev = False
      if self.btn_next is None:
        self.btn_next = False
      if self.btn_speak is None:
        self.btn_speak = False
      if self.btn_call_start is None:
        self.btn_call_start = False
      if self.btn_call_end is None:
        self.btn_call_end = False
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_4Bf43B().pack(_x.turn_signal.value, _x.high_beam_headlights, _x.wiper.status, _x.ambient_light.status, _x.outside_temperature, _x.btn_cc_on, _x.btn_cc_off, _x.btn_cc_on_off, _x.btn_cc_res, _x.btn_cc_cncl, _x.btn_cc_res_cncl, _x.btn_cc_res_inc, _x.btn_cc_res_dec, _x.btn_cc_set_inc, _x.btn_cc_set_dec, _x.btn_cc_gap_inc, _x.btn_cc_gap_dec, _x.btn_la_on_off, _x.btn_ld_ok, _x.btn_ld_up, _x.btn_ld_down, _x.btn_ld_left, _x.btn_ld_right, _x.btn_rd_ok, _x.btn_rd_up, _x.btn_rd_down, _x.btn_rd_left, _x.btn_rd_right, _x.btn_vol_inc, _x.btn_vol_dec, _x.btn_mute, _x.btn_media, _x.btn_prev, _x.btn_next, _x.btn_speak, _x.btn_call_start, _x.btn_call_end, _x.fault_bus, _x.door_driver, _x.door_passenger, _x.door_rear_left, _x.door_rear_right, _x.door_hood, _x.door_trunk, _x.passenger_detect, _x.passenger_airbag, _x.buckle_driver, _x.buckle_passenger))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.turn_signal.value, _x.high_beam_headlights, _x.wiper.status, _x.ambient_light.status, _x.outside_temperature, _x.btn_cc_on, _x.btn_cc_off, _x.btn_cc_on_off, _x.btn_cc_res, _x.btn_cc_cncl, _x.btn_cc_res_cncl, _x.btn_cc_res_inc, _x.btn_cc_res_dec, _x.btn_cc_set_inc, _x.btn_cc_set_dec, _x.btn_cc_gap_inc, _x.btn_cc_gap_dec, _x.btn_la_on_off, _x.btn_ld_ok, _x.btn_ld_up, _x.btn_ld_down, _x.btn_ld_left, _x.btn_ld_right, _x.btn_rd_ok, _x.btn_rd_up, _x.btn_rd_down, _x.btn_rd_left, _x.btn_rd_right, _x.btn_vol_inc, _x.btn_vol_dec, _x.btn_mute, _x.btn_media, _x.btn_prev, _x.btn_next, _x.btn_speak, _x.btn_call_start, _x.btn_call_end, _x.fault_bus, _x.door_driver, _x.door_passenger, _x.door_rear_left, _x.door_rear_right, _x.door_hood, _x.door_trunk, _x.passenger_detect, _x.passenger_airbag, _x.buckle_driver, _x.buckle_passenger,) = _get_struct_4Bf43B().unpack(str[start:end])
      ...
      self.btn_rd_ok = bool(self.btn_rd_ok)
      self.btn_rd_up = bool(self.btn_rd_up)
      self.btn_rd_down = bool(self.btn_rd_down)
      self.btn_rd_left = bool(self.btn_rd_left)
      self.btn_rd_right = bool(self.btn_rd_right)
      self.btn_vol_inc = bool(self.btn_vol_inc)
      self.btn_vol_dec = bool(self.btn_vol_dec)
      self.btn_mute = bool(self.btn_mute)
      self.btn_media = bool(self.btn_media)
      self.btn_prev = bool(self.btn_prev)
      self.btn_next = bool(self.btn_next)
      self.btn_speak = bool(self.btn_speak)
      self.btn_call_start = bool(self.btn_call_start)
      self.btn_call_end = bool(self.btn_call_end)
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_4Bf43B = None
def _get_struct_4Bf43B():
    global _struct_4Bf43B
    if _struct_4Bf43B is None:
        _struct_4Bf43B = struct.Struct("<4Bf43B")
    return _struct_4Bf43B
