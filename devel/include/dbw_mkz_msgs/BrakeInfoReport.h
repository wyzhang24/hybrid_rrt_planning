...
struct BrakeInfoReport_
{
  ...
  _accel_over_ground_type accel_over_ground;
   ...
   typedef  ::dbw_mkz_msgs::QualityFactor_<ContainerAllocator>  _brake_pedal_qf_type;
  _brake_pedal_qf_type brake_pedal_qf;
...
struct MD5Sum< ::dbw_mkz_msgs::BrakeInfoReport_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xf0dc6f9424f2cb9fULL;
  static const uint64_t static_value2 = 0xca59bce960b68010ULL;
};
...
struct Printer< ::dbw_mkz_msgs::BrakeInfoReport_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dbw_mkz_msgs::BrakeInfoReport_<ContainerAllocator>& v)
  {
    ...
    s << indent << "brake_pedal_qf: ";
    s << std::endl;
    Printer< ::dbw_mkz_msgs::QualityFactor_<ContainerAllocator> >::stream(s, indent + "  ", v.brake_pedal_qf);
    s << indent << "hsa: ";
    s << std::endl;
