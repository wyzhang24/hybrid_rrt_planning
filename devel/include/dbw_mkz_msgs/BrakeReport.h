...
struct BrakeReport_
{
  ...
  _torque_output_type torque_output;
   ...
   typedef float _decel_cmd_type;
  _decel_cmd_type decel_cmd;

   typedef float _decel_output_type;
  _decel_output_type decel_output;
...
struct MD5Sum< ::dbw_mkz_msgs::BrakeReport_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xd99bccbe9927a921ULL;
  static const uint64_t static_value2 = 0x47840ac1ddf11f87ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dbw_mkz_msgs::BrakeReport_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.decel_cmd);
      stream.next(m.decel_output);
...
struct Printer< ::dbw_mkz_msgs::BrakeReport_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dbw_mkz_msgs::BrakeReport_<ContainerAllocator>& v)
  {
    ...
    s << indent << "decel_cmd: ";
    Printer<float>::stream(s, indent + "  ", v.decel_cmd);
    s << indent << "decel_output: ";
    Printer<float>::stream(s, indent + "  ", v.decel_output);
    s << indent << "boo_input: ";
