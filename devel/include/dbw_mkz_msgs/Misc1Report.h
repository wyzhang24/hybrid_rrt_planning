...
struct Misc1Report_
{
  ...
  _ambient_light_type ambient_light;
   ...
   typedef float _outside_temperature_type;
  _outside_temperature_type outside_temperature;
  ...
  _btn_ld_right_type btn_ld_right;
   ...
   typedef uint8_t _btn_rd_ok_type;
  _btn_rd_ok_type btn_rd_ok;

   typedef uint8_t _btn_rd_up_type;
  _btn_rd_up_type btn_rd_up;

   typedef uint8_t _btn_rd_down_type;
  _btn_rd_down_type btn_rd_down;

   typedef uint8_t _btn_rd_left_type;
  _btn_rd_left_type btn_rd_left;

   typedef uint8_t _btn_rd_right_type;
  _btn_rd_right_type btn_rd_right;

   typedef uint8_t _btn_vol_inc_type;
  _btn_vol_inc_type btn_vol_inc;

   typedef uint8_t _btn_vol_dec_type;
  _btn_vol_dec_type btn_vol_dec;

   typedef uint8_t _btn_mute_type;
  _btn_mute_type btn_mute;

   typedef uint8_t _btn_media_type;
  _btn_media_type btn_media;
  ...
  _btn_next_type btn_next;
   ...
   typedef uint8_t _btn_speak_type;
  _btn_speak_type btn_speak;

   typedef uint8_t _btn_call_start_type;
  _btn_call_start_type btn_call_start;

   typedef uint8_t _btn_call_end_type;
  _btn_call_end_type btn_call_end;
...
struct MD5Sum< ::dbw_mkz_msgs::Misc1Report_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x551ea602464aaab2ULL;
  static const uint64_t static_value2 = 0x2bc1752e844dde30ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dbw_mkz_msgs::Misc1Report_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.outside_temperature);
      ...
      stream.next(m.btn_rd_ok);
      stream.next(m.btn_rd_up);
      stream.next(m.btn_rd_down);
      stream.next(m.btn_rd_left);
      stream.next(m.btn_rd_right);
      stream.next(m.btn_vol_inc);
      stream.next(m.btn_vol_dec);
      stream.next(m.btn_mute);
      stream.next(m.btn_media);
      stream.next(m.btn_prev);
      stream.next(m.btn_next);
      stream.next(m.btn_speak);
      stream.next(m.btn_call_start);
      stream.next(m.btn_call_end);
...
struct Printer< ::dbw_mkz_msgs::Misc1Report_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dbw_mkz_msgs::Misc1Report_<ContainerAllocator>& v)
  {
    ...
    s << indent << "outside_temperature: ";
    Printer<float>::stream(s, indent + "  ", v.outside_temperature);
    s << indent << "btn_cc_on: ";
    ...
    s << indent << "btn_rd_ok: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.btn_rd_ok);
    s << indent << "btn_rd_up: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.btn_rd_up);
    s << indent << "btn_rd_down: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.btn_rd_down);
    s << indent << "btn_rd_left: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.btn_rd_left);
    s << indent << "btn_rd_right: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.btn_rd_right);
    s << indent << "btn_vol_inc: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.btn_vol_inc);
    s << indent << "btn_vol_dec: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.btn_vol_dec);
    s << indent << "btn_mute: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.btn_mute);
    s << indent << "btn_media: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.btn_media);
    s << indent << "btn_prev: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.btn_prev);
    s << indent << "btn_next: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.btn_next);
    s << indent << "btn_speak: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.btn_speak);
    s << indent << "btn_call_start: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.btn_call_start);
    s << indent << "btn_call_end: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.btn_call_end);
    s << indent << "fault_bus: ";
