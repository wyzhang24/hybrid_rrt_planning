...
struct FuelLevelReport_
{
  ...
  _fuel_level_type fuel_level;
   ...
   typedef float _battery_12v_type;
  _battery_12v_type battery_12v;

   typedef float _battery_hev_type;
  _battery_hev_type battery_hev;
...
struct MD5Sum< ::dbw_mkz_msgs::FuelLevelReport_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xf937217d0b14552dULL;
  static const uint64_t static_value2 = 0x7365d7cdca64a7ffULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dbw_mkz_msgs::FuelLevelReport_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.battery_12v);
      stream.next(m.battery_hev);
...
struct Printer< ::dbw_mkz_msgs::FuelLevelReport_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dbw_mkz_msgs::FuelLevelReport_<ContainerAllocator>& v)
  {
    ...
    s << indent << "battery_12v: ";
    Printer<float>::stream(s, indent + "  ", v.battery_12v);
    s << indent << "battery_hev: ";
    Printer<float>::stream(s, indent + "  ", v.battery_hev);
    s << indent << "odometer: ";
